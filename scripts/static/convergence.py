...
# Energy convergence plot for NH3/ND3 double well
#
# Usage:
#   cd examples/NH3
#   python ../../grafica/convergencia_E_vs_N.py
#
#   Or specify output directory:
#   python ../../grafica/convergencia_E_vs_N.py --output ../ND3/output
#
# Generates: convergencia_E_vs_N.pdf in current directory
# _____________________________________________________________________________
...
parse_args(description="Plot energy convergence vs basis size for NH3/ND3")
