...
nombre_grafica = 'probabilidad_supervivencia_psi01.pdf'


fichero_datos_1 = data('out-probabilidad_supervivencia_Psi0.dat')
fichero_datos_2 = data('out-probabilidad_supervivencia_Psi1.dat')
